...
pacman::p_load(dplyr,ggplot2,tidyr,janitor,vroom,hrbrthemes,deSolve,furrr)
dyn.load("decay_ODE_arm64.so")
```
...
# sim<- ode(initial_contamination, time_space, ode_model, parameters, method = "radau",atol = 1e-4, rtol = 1e-4)
sim <- ode(Y, time_space, func = "derivs", parms = parameters, dllname = "decay_ODE", method = "radau",
...
```{r}
p<-ode(initial_contamination, time_space, ode_model, c(r=100,C=10555,d=5055,g=55,l=90), method = "radau",atol = 1e-4, rtol = 1e-4)
